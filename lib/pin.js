...
// Delegate fields to underlying sysfs object
let delegate = ['value', 'edge', 'direction', 'activeLow'];
delegate.forEach((field) => {
  Object.defineProperty(pin, field, {
    get: function() { return this.sysfs[field]; }
  });
});
