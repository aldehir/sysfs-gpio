...
pin.__watchDebounce = function(value) {
  if (!this._debouncing.running) {
    ...
    this._debouncing.time = process.hrtime();
    this._debouncing.last = value;

    // Call the debounce poll function now and then poll after
...
pin.debounce = function(delay) {
  ...
  this._debouncing.delay = (delay || 20) * 1e6;
  return this;
}
